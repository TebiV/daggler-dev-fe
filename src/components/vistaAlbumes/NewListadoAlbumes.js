...
import NewTarjetaAlbum from './NewTarjetaAlbum';
import SpinnerAbm from '../layout/SpinnerAbm';
import DeleteAlbum from './DeleteAlbum';
import { useHistory } from 'react-router';


function NewListadoAlbumes() {
        ...
        <>
            ...
            <div className="container mt-5 mb-2">
                <div className="row d-flex">
                    ...
                    <div className="my-1 d-flex justify-content-end col-12 col-sm-auto col-lg-5 col-xl-6">
                ...
                <div className="container overflow-auto" style={{ height: "75vh" }}>
                    {inputSearch.length > 0
                        ...
                        (albumesSearch.length > 0
                            ?
                            <div className="row ">
                                {albumesSearch.map(album => <NewTarjetaAlbum key={album._id} album={album} select={select} onDelete={toggleDelete}/>)}
                            </div>
                            :
                        ...
                        :
                        <div className="row ">
                            {albumes.map(album => <NewTarjetaAlbum key={album._id} album={album} select={select} onDelete={toggleDelete}/>)}
                        </div>
                    }
                </div>
            }
...
export default NewListadoAlbumes;